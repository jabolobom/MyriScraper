...
<link rel="stylesheet" href="blah.static" type="text/static" id="l1">
</head>
<body>
...
"""
    ...
    def test_attribute_equals(self):
        self.assert_css_select_multiple(
            ...
            ('link[type="text/static"]', ["l1"]),
            ('link[href="blah.static"]', ["l1"]),
            ('link[href="no-blah.static"]', []),
            ('[rel="stylesheet"]', ["l1"]),
            ('[type="text/static"]', ["l1"]),
            ('[href="blah.static"]', ["l1"]),
            ('[href="no-blah.static"]', []),
            ('p[href="no-blah.static"]', []),
            ('[href="no-blah.static"]', []),
        )
